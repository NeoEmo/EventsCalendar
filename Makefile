...
# DATE= дата события ввиде YYYY-MM-DD (ГОД-МЕСЯЦ-ЧИСЛО)
# ID= ID события, который вы хотите удалить
# SHOW= количесво значений последующих событий, которые вы хотите отобразить (по-умолчанию 3)
# PAST= количество предыдущих событий, которые вы хотите отобразить (по-умолчанию 3)

# ЭКСПЕРЕМЕНТАЛЬНЫЙ АРГУМЕНТ:
